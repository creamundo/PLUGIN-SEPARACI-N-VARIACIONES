...
use Iconic_WSSV_NS\lucatume\DI52\Container as DI52Container;

/**
 * Iconic_WSSV_Core_Container.
 *
 * @class    Iconic_WSSV_Core_Container
 * @version  1.0.0
 */
class Iconic_WSSV_Core_Container implements ContainerInterface {
	/**
	 ...
	 *
	 * @return void
	 * @throws \Iconic_WSSV_NS\lucatume\DI52\ContainerException Throws exception.
	 */
