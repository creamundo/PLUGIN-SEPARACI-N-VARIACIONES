...
namespace Iconic_WSSV_NS\StellarWP\Uplink\View;

use Iconic_WSSV_NS\StellarWP\Uplink\View\Exceptions\FileNotFoundException;
	...
	private function get_path( string $name ): string {
		...
		if( $path === false ) {
			throw new FileNotFoundException(
				sprintf( __( 'View file "%s" not found or not readable.', 'iconic-wssv' ), $file )
			);
		}
