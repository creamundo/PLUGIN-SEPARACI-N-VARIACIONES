...
namespace Iconic_WSSV_NS\StellarWP\Telemetry;

use Iconic_WSSV_NS\StellarWP\ContainerContract\ContainerInterface;
use Iconic_WSSV_NS\StellarWP\Telemetry\Admin\Admin_Subscriber;
use Iconic_WSSV_NS\StellarWP\Telemetry\Admin\Resources;
use Iconic_WSSV_NS\StellarWP\Telemetry\Contracts\Data_Provider;
use Iconic_WSSV_NS\StellarWP\Telemetry\Data_Providers\Debug_Data;
use Iconic_WSSV_NS\StellarWP\Telemetry\Events\Event_Subscriber;
use Iconic_WSSV_NS\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use Iconic_WSSV_NS\StellarWP\Telemetry\Exit_Interview\Template;
use Iconic_WSSV_NS\StellarWP\Telemetry\Last_Send\Last_Send;
use Iconic_WSSV_NS\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use Iconic_WSSV_NS\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use Iconic_WSSV_NS\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use Iconic_WSSV_NS\StellarWP\Telemetry\Opt_In\Status;
use Iconic_WSSV_NS\StellarWP\Telemetry\Telemetry\Telemetry;
use Iconic_WSSV_NS\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \Iconic_WSSV_NS\StellarWP\ContainerContract\ContainerInterface
	 */
